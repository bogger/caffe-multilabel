...
for i=1:1
    ...
    cmd
    system(cmd);
    cmd =['convert_imageset.bin ',rootfd_test,' ',listfd,'test_car_',attr_type,'_crop_',num2str(i),...
       ' ',dbfd,'test_leveldb 0'];
    system(cmd);
...
%         'imagenet_finetune_car_',num2str(i),'_iter_',num2str(iters(i))];
