...
rootfd ='~/work/data/verification_add_resize/';
...
dbfd='~/work/caffe_data/';
    ...
    cmd =['convert_imageset.bin ',rootfd,' ',listfd,'verification_add_car',...
       ' ',dbfd,'test_leveldb 0'];
    ...
    save_name = ['verification_add_feature'];
    if exist(save_name,'dir')
        rmdir(save_name,'s');
    end
    
    minibatch_n = '120';%per batch 200
