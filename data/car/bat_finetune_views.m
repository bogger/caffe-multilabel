...
for i=3:5
    ...
    cmd= ['convert_imageset.bin ',rootfd,' ',listfd,'train_car_',num2str(i),...
...
%     system(cmd);
    ...
    fprintf(f2,'stepsize: 500\n');
    fprintf(f2,'display: 50\n');
    fprintf(f2,'max_iter: 1500\n');
    fprintf(f2,'momentum: 0.9\n');
    fprintf(f2,'weight_decay:0.0005\n');
    fprintf(f2,'snapshot: 1500\n');
    fprintf(f2,'snapshot_prefix: ');
   
    fprintf(f2, '\"imagenet_finetune_car_%d\"\n',i);
