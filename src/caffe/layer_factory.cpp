...
Layer<Dtype>* GetLayer(const LayerParameter& param) {
  ...
  case LayerParameter_LayerType_LOCAL:
    return new LocallyConnectedLayer<Dtype>(param);
  case LayerParameter_LayerType_WINDOW_DATA_FEAT_EXTRACT:
    return new WindowDataFeatExtractLayer<Dtype>(param);
  case LayerParameter_LayerType_WINDOW_DATA_NO_BG:
  ...
  case LayerParameter_LayerType_EUCLIDEAN_LOSS_255:
    return new Euclidean255LossLayer<Dtype>(param);
  case LayerParameter_LayerType_HINGE_LOSS_1023:
    return new TargetCoding1023HingeLossLayer<Dtype>(param);
  case LayerParameter_LayerType_HINGE_LOSS_4_DET:
    return new HingeLoss4DetLayer<Dtype>(param);
  case LayerParameter_LayerType_L2_LOSS:
    return new L2LossLayer<Dtype>(param);
  case LayerParameter_LayerType_BINARYACCURACY_1023_1000:
    return new TargetCodingBinary1023_1000AccuracyLayer<Dtype>(param);
  case LayerParameter_LayerType_ACCURACY_1023_1000:
    return new TargetCoding1023_1000AccuracyLayer<Dtype>(param);
  case LayerParameter_LayerType_ACCURACY_1023_569:
    return new TargetCoding1023_569AccuracyLayer<Dtype>(param);
  case LayerParameter_LayerType_ACCURACY_255_200:
    return new TargetCoding255_200AccuracyLayer<Dtype>(param);
